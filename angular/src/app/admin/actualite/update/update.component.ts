...
export class UpdateComponent implements OnInit {
  ...
  folderToSaveInServer = 'actualites';
  ...
  onOkClick(o: Actualite): void {
    if (o.id === 0) {
      o.id = null;
      this.uow.actualites.post(o).subscribe(r => {
        this.eventSubmitFromParent.next(true);
        this.dialogRef.close(o);
      });
    } else {
      this.uow.actualites.put(o.id, o).subscribe(r => {
        this.eventSubmitFromParent.next(true);
        this.dialogRef.close(o);
      });
    }
