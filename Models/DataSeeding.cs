...
.RuleFor(o => o.NomParent, f => id - 1 == 1 ? null : id - 2)
.RuleFor(o => o.PrenomParent, f => id - 1 == 1 ? null : id - 2)
.RuleFor(o => o.Tel1Parent, f => id - 1 == 1 ? null : id - 2)
.RuleFor(o => o.Tel2Parent, f => id - 1 == 1 ? null : id - 2)
.RuleFor(o => o.IdUser, f => f.Random.Number(1, 10))
;
...
.RuleFor(o => o.Responses, f => f.Lorem.Word())
