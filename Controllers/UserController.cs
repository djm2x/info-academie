...
namespace Controllers
{
    ...
    public class UsersController : SuperController<User>
    {
        ...
        [HttpGet("{startIndex}/{pageSize}/{sortBy}/{sortDir}/{nom}/{prenom}/{tel1}/{tel2}/{email}/{adresse}/{cin}/{role}/{idVille}")]
        public async Task<IActionResult> GetAll(int startIndex, int pageSize, string sortBy, string sortDir, string nom, string prenom, string tel1, string tel2, string email, string adresse, string cin, string role, int idVille)
        {
