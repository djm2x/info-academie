...
namespace Controllers
{
    ...
    public class OffreProfsController : SuperController<OffreProf>
    {
        ...
        [HttpGet("{startIndex}/{pageSize}/{sortBy}/{sortDir}/{interval}/{value}/{idTypeCours}")]
        public async Task<IActionResult> GetAll(int startIndex, int pageSize, string sortBy, string sortDir, string interval, int value, int idTypeCours)
        {
