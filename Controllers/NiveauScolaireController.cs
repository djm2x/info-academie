...
namespace Controllers
{
    ...
    public class NiveauScolairesController : SuperController<NiveauScolaire>
    {
        ...
        [HttpGet("{startIndex}/{pageSize}/{sortBy}/{sortDir}/{nom}/{nomAr}/{idCycle}/{coursLigneGroupe}/{coursLigneIndividuel}/{coursDomicileGroupe}/{coursDomicileIndividuel}")]
        public async Task<IActionResult> GetAll(int startIndex, int pageSize, string sortBy, string sortDir, string nom, string nomAr, int idCycle, int coursLigneGroupe, int coursLigneIndividuel, int coursDomicileGroupe, int coursDomicileIndividuel)
        {
